...
<div class="container mx-auto">
    <div class="bg-white p-6 rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold mb-4">Kullanıcı Ekle</h2>
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            @enderror
            <div class="mb-4">
                <label for="password_confirmation" class="block text-gray-700">Şifre Doğrulama</label>
            ...
            <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded-lg">Kullanıcı Ekle</button>
        </form>
    </div>
</div>
@endsection
