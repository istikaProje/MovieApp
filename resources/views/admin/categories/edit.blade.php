...
<div class="container mx-auto h-screen">
    <h2 class="text-2xl font-bold mb-4 mt-4 text-white">Kategori Güncelle</h2>
    ...
    <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
        ...
        <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded-md">Kategoriyi Güncelle</button>
    </form>
</div>
@endsection
