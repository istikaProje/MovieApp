    ...
    <div class="video-player flex items-center justify-center min-h-screen bg-black" oncontextmenu="return false;">
             <!-- Video Player -->
              ...
              <script>
                ...
                const movieId = {{ $movie->id }}; // Dinamik film ID'si
                let isPaused = true;
                let isMouseOver = false;
                let hideControlsTimeout;
                let lastCall = 0; // Throttle için zaman damgası
                ...
                // İzleme ilerlemesini kaydetme işlevi
                ...
                // Throttle edilmiş kaydetme işlevi
                ...
                function setSpeed(speed) {
                    ...
                    const targetItem = Array.from(items).find(
                        (item) => parseFloat(item.getAttribute("data-speed")) === speed
                    );
                    if (targetItem) {
