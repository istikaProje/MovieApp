...
unset($__errorArgs, $__bag); ?>
        ...
        <?php if($errors->has('failure')): ?>
            <p class="error"><?php echo e($errors->first('failure')); ?></p>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.adminMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\MovieApp\resources\views/admin/login.blade.php ENDPATH**/ ?>