      ...
      <div class="h-full px-3 bg-gradient-to-b from-gray-800 to-gray-900 text-white">
         <ul class="space-y-4 font-medium">
            ...
            <li class="group relative ">
               <a href="<?php echo e(route('admin.dashboard')); ?>"
                  ...
                  <i class="icon-Users text-gray-400 transition duration-200 group-hover:text-white" style="font-size: 24px;"></i> <!-- Ratio SVG -->
        ...
        <!-- Logout -->
            ...
            <li class="group relative">
               <a href="#"
                  class="flex  items-center p-3 rounded-lg hover:bg-gray-700 group transition-all duration-200">
                  <i class="icon-Logout text-gray-400 transition duration-200 group-hover:text-white" style="font-size: 24px;"></i> <!-- Logout 2 SVG -->
