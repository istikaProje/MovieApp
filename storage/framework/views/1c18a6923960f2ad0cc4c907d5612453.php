   ...
   <div class="flex flex-wrap items-stretch">
    ...
    <div class="w-full lg:w-1/2">
     <div class="w-full py-14 px-8 sm:p-[70px] lg:px-14 xl:px-[90px]">
      ...
      <form id="register-form" action="<?php echo e(route('register')); ?>" method="post">
       <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
       ...
       <div class="mb-4">
        <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter your email" class="<?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> !ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
       ...
       <div class="mb-4">
        <input type="password" name="password" placeholder="Enter your Password" class="<?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> !ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
       ...
       <div class="mb-8">
        <input type="password" name="password_confirmation" placeholder="Confirm Password" class="<?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> !ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> focus:border-primary h-12 w-full rounded-lg border border-transparent bg-[#F6F6F6] px-5 outline-none focus-visible:shadow-none" />
       ...
       <div class="mb-8 flex flex-wrap justify-between">
        ...
        <div x-data="{ open: false }">
              <p>
                I agree with the
                <a id="terms-link" class="font-medium hover:text-slate-800 underline" @click="open = true">terms and conditions</a>.
              </p>
