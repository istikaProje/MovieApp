...
<link rel="stylesheet" href="<?php echo e(asset('Icons/style.css')); ?>">
    ...
    <section class="relative z-10 py-20">
         ...
         <!-- Video Player -->
            <div class="video-player" style=" display: block; margin-left: auto; margin-right: auto;" oncontextmenu="return false;"> <!-- div video player için div oncontextmenu="return false;" sağ tık'ı kapatıyor  -->
                ...
                <div class="controls">
                  ...
                  <img src="<?php echo e(asset('images/Sound.png')); ?>"  style="max-width: 25px; max-height: 20px; margin-top: 10px; margin-left: 5px; cursor: pointer;" />
                  <input
                    type="range"
                    name="volume"
                  ...
                  <div class="flex items-center justify-end space-x-2 ml-auto" style="margin-left: auto;">
                    ...
                    <div class="dropdown relative">
                        <button onclick="toggleDropdown()" class="dropdown-toggle cursor-pointer bg-transparent-200 p-2 rounded">
                            <img src="<?php echo e(asset('images/Speed.png')); ?>" alt="Dropdown Icon" class="w-6 h-6" />
                        </button>
                  ...
                  <img src="<?php echo e(asset('images/Fullscreen.png')); ?>" onclick="openFullscreen();" style="max-width: 30px; cursor: pointer;" />
        ...
        <script>
            ...
            xhr.open("GET", "<?php echo e(asset('videos/videom2.mp4')); ?>");
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\MovieApp\resources\views/layouts/movie.blade.php ENDPATH**/ ?>