...
<section class="flex w-full mt-4 items-start">
    <div class="w-full px-4">
        ...
        <form action="<?php echo e(route('admin.movies.store')); ?>" method="POST" enctype="multipart/form-data" novalidate>
            <?php echo csrf_field(); ?>
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full px-3 md:w-1/2">
                                <div class="mb-[30px]">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="title" id="title" value="<?php echo e(old('title')); ?>"  placeholder="Title"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="w-full px-3 md:w-1/2">
                                <div class="mb-[30px]">
                                    ...
                                    <?php if(old('image')): ?>
                                        <p class="text-green-500 text-xs mt-1">Image selected: <?php echo e(old('image')); ?></p>
                                    <?php endif; ?>
                            ...
                            <div class="w-full px-3 md:w-1/2">
                                <div class="mb-[30px]">
                                    ...
                                    <input type="file" name="video" id="video" accept="video/mp4,video/mov,video/ogg,video/qt"
                                        class="w-full rounded-md border border-[#E0E0E0] p-3 text-base text-black outline-none focus:border-primary" />
                                    <?php if(old('video')): ?>
                                        <p class="text-green-500 text-xs mt-1">Video selected: <?php echo e(old('video')); ?></p>
                                    <?php endif; ?>
                            ...
                            <div class="w-full px-3 md:w-1/2">
                                <div class="mb-[30px]">
                                    ...
                                    <input type="file" name="poster" id="poster" accept="image/jpeg,image/png,image/jpg,image/gif,image/svg,image/webp"
                                        class="w-full rounded-md border border-[#E0E0E0] p-3 text-base text-black outline-none focus:border-primary" />
                                    <?php if(old('poster')): ?>
                                        <p class="text-green-500 text-xs mt-1">Poster selected: <?php echo e(old('poster')); ?></p>
                                    <?php endif; ?>
...
<?php /**PATH C:\wamp64\www\MovieApp\resources\views/layouts/sections/admin/_createMovies.blade.php ENDPATH**/ ?>