...
<section class="container mx-auto">
    ...
    <?php echo $__env->make('layouts.sections._slideHero', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make('layouts.sections._slideFirst', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('layouts.sections._slideSecond', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


    <?php $__env->startPush('styles'); ?>
        <?php echo app('Illuminate\Foundation\Vite')(['resources/css/swiper.css']); ?> <!-- Swiper CSS dosyanızı ekleyin -->
    <?php $__env->stopPush(); ?>

    <?php $__env->startPush('scripts'); ?>
        <?php echo app('Illuminate\Foundation\Vite')(['resources/js/swiper.js']); ?> <!-- Swiper JS dosyanızı ekleyin -->
        <script>
    ...
    <?php if(auth()->guard()->guest()): ?>
                ...
                <div class="w-full p-8   md:min-h-[41rem]">
                    <div class="wrap-video">
                        <video class=" shadow-[-13px_14px_6px_-5px_#ff5758] inline w-full h-full object-center object-cover rounded-2xl" preload="metadata" data-src="<?php echo e(asset('videos/PeakyBlinders.webm')); ?>"  src="<?php echo e(asset('videos/PeakyBlinders.webm')); ?>"></video>
                ...
                <div class="relative flex  flex-col">
                    <div class="min-h-28">
                            ...
                            <div class="gap-6 mt-8 mx-4 md:flex">
                                <div class="md:w-1/2">
                                    <div class="wrap-video">
                                        ...
                                        <video class=" object-contain h-96 w-full "  src="<?php echo e(asset('videos/BreakingBad.webm')); ?>"></video>
                                ...
                                <div class="md:w-1/2">
                                    <div class="wrap-video">
                                        <video class=" object-contain h-96 w-full "  src="<?php echo e(asset('videos/TheFastandtheFurious.webm')); ?>"></video>
                        ...
                        <div class="gap-6 mt-8 mx-4 md:flex">
                            <div class="md:w-1/2">
                                <div class="wrap-video">
                                    <video class=" object-contain h-96 w-full "  src="<?php echo e(asset('videos/Nobody.webm')); ?>"></video>
                                </div>
                            ...
                            <div class="md:w-1/2">
                                <div class="wrap-video">
                                    <div class="wrap-video">
                                        <video class=" object-contain h-96 w-full "  src="<?php echo e(asset('videos/johnwick.webm')); ?>"></video>
                                    </div>
                                </div>   
                            </div>
                        </div>
