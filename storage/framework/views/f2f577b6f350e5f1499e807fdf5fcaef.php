          ...
          <div class=" flex flex-wrap">
            <div class="w-full px-4 sm:w-2/3 lg:w-4/12 xl:w-3/12">
              <div class="mb-10 w-full">
                ...
                >
                  <img
                  src="<?php echo e(asset('images/MovieWatchLogo.png')); ?>"
                    alt="logo"
                    class="max-w-full"
                  />
                </a>
 ...
 <i class="icon-Dot w-24 h-24" style="font-size: 24px; color: #ff5722;"> </i>
          </span>
        </div>
      </footer>
      <!-- ====== Footer Section End -->
<?php /**PATH C:\wamp64\www\MovieApp\resources\views/layouts/footer.blade.php ENDPATH**/ ?>